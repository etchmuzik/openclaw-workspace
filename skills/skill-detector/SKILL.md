...
Then immediately show the drafted SKILL.md — don't wait for a second confirmation.
...
Update this file whenever you detect, suggest, or create a skill.
This makes the detector smarter across sessions.

## ✍️ Auto-Drafting (When Suggesting or Asked)

When drafting a skill, produce a complete, ready-to-save SKILL.md — not an outline.
